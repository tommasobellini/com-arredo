      ...
      <div className="container footer-shell">
        <div className="footer-grid">
          <div className="footer-col footer-col--brand">
            ...
            <p className="footer-tagline">
              Falegnameria artigianale dal {site.founded}. Mobili su misura, infissi in legno
              e arredi d&apos;interni realizzati a mano a Cortenuova (BG).
            </p>
          </div>
          ...
          <nav className="footer-col footer-col--nav" aria-label="Navigazione footer">
            ...
            <div className="footer-legal">
              <ul className="footer-links footer-links--legal">
        ...
        <div className="footer-bar">
          <p className="footer-meta">
            ...
            <span className="footer-meta-dot footer-meta-dot--hide-sm" aria-hidden>·</span>
            <span className="footer-meta-tagline">Artigianato italiano dal {site.founded}</span>
          </p>

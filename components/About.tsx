...
import { useStickyImageParallax } from '@/lib/parallax'

export default function About() {
  const { ref, bgY, bgScale, contentY } = useStickyImageParallax()

  return (
    <section ref={ref} id="about" className="relative bg-antracite about-parallax-section">
      <div className="about-parallax-sticky" aria-hidden>
        <motion.div
          className="about-parallax-bg parallax-layer"
        ...
        >
          <Image
            ...
            style={{ opacity: 0.45, objectPosition: 'center 50%' }}
          />
          <div className="absolute inset-0 about-overlay" />
        </motion.div>
      </div>

      <motion.div className="about-parallax-content parallax-layer" style={{ y: contentY }}>
        <div className="container py-32 min-h-screen flex items-center">
